...
class Building_type(models.Model):
    name=models.CharField(max_length=30, vebose_name='Building type')

class Neighborhood(models.Model):
    name=models.CharField(max_length=30, vebose_name='Neighborhood')
    risk_level=models.IntegerField(verbose_naem='Risk level')

class Building(models.Model):
    name = models.CharField(max_length=30, vebose_name='Building name')
    address = models.CharField(max_length=30, vebose_name='Address')
